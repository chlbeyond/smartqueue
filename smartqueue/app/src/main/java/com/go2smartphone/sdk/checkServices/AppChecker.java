...
public class AppChecker {
	...
	public void checkApkUpdate(final FragmentActivity context, String apkupdateUrl, final String deviceId, String salt, final CheckListener listener){
		final LoadingDialog loadingDialog = new LoadingDialog(context);
		loadingDialog.show();
		loadingDialog.setToolTipText("检查新版本...");
		new CheckAPKUpdate(context, apkupdateUrl,deviceId, salt, new CheckAPKUpdate.ICheckApkUpdateListener() {
