package com.go2smartphone.sdk.androidUtil;
...
public class SmartPosPrivateKey {
    ...
    public static final String ST_IS_SNACK_INPUT_NUMBER = "snack_input_number";
    public static final String ST_LOCAL_PRESENTATION = "local_media_directory";

    public static final String ST_LOCAL_SEATCH_TYPE = "seatch_is_num";
    public static final String ST_LOCAL_INPUT_TYPE = "input_is_num";
